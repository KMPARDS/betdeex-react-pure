            ...
            <div className="market-basics-styles_MarketBasics__header mb-3">
              <div className="category-tag-trail-styles_CategoryTagTrail">
                <div className="word-trail-styles_WordTrail">
                  ...
                  <button data-testid="Category-0" className="tag-trail-button">{categoryArray[this.props.category]}</button>
                </div>
                <div className="word-trail-styles_WordTrail">
                  <div className="word-trail-styles_WordTrail__label">Sub Category</div>
                  <button data-testid="Tags-0" className="tag-trail-button">{subCategoryArray[this.props.category][this.props.subCategory]}</button>
                </div>
              </div>
            </div>
